...
<div style="display: flex;">
    ...
    <div style="flex: 1;">
        <a type="submit" target="_blank" href="/admin/reporte_curso.php" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">

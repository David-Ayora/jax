...
$query_año_lectivo = mysqli_query($conexion, 'SELECT periodo_inicio, periodo_final FROM año_lectivo ORDER BY id DESC;');
...
<div style="flex: 3; text-align: center;">
	<button type="submit" class="btn btn-danger" id="prev_validar"> Validar</button>
</div><br>

<div class="menu">
	<ul class="ul-add">
		<li class="li-add"><a href="#" data-tab="item1" class="a-add">Estudiante</a></li>
		<li class="li-add"><a href="#" data-tab="item2" class="a-add">Representante</a></li>
		<li class="li-add"><a href="#" data-tab="item3" class="a-add">Padre</a></li>
		<li class="li-add"><a href="#" data-tab="item4" class="a-add">Madre</a></li>
		<li class="li-add"><a href="#" data-tab="item5" class="a-add">Otros</a></li>
	</ul>
...
<script>
	...
	const grado = document.getElementById("grado_estudiantil");
